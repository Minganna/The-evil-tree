...
public class TextureCreatingWindow : EditorWindow
{
    ...
    [MenuItem("Window/Textures/TextureCreatorWindow")]
    public static void ShowWindow()
    {
        EditorWindow.GetWindow(typeof(TextureCreatingWindow));
    }
    ...
    private void OnGUI()
    {
        ...
        perlinOffsetX= EditorGUILayout.IntSlider("Offset X", perlinOffsetX, 0, 1000);
        perlinOffsetY = EditorGUILayout.IntSlider("Offset Y", perlinOffsetY, 0, 1000);
